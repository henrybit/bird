...
/**
 * Servlet implementation class GetPlazaActivityList
 */
public class GetPlazaActivityList extends BaseServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public GetPlazaActivityList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String json = PlazaActivityManager.getInstance().getPlazaActivityList(parameters);
